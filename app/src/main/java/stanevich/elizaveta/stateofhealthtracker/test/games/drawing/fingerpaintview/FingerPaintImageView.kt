package stanevich.elizaveta.stateofhealthtracker.test.games.drawing.fingerpaintview
...
class FingerPaintImageView @JvmOverloads constructor(context: Context,
    ...
    private val defaultStrokeColor = Color.YELLOW
    private val defaultStrokeWidth = 25f
